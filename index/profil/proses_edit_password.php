<?php
	...
	$get_old_pass = mysqli_query($db_dash, "SELECT * FROM user WHERE id_user = '".$_POST['id_user']."' ");
	$row_old_pass = mysqli_fetch_array($get_old_pass);

	if($_POST['pswd_new'] == $_POST['re_pswd_new']){
		$save_edit_pass = mysqli_query($db_dash, "UPDATE user SET password = '".$user_password_new."' WHERE id_user = '".$_POST['id_user']."' ");
